...
describe("Get Riders Count by Age Group", function () {
  ...
  it("Should 500 when invalid stationId is passed", function (done) {
    chai
      .request(app)
      .get("/stations/xxx/ridersByAge?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
        expect(res.body.errors).to.eql("Invalid Number");
  ...
  it("Should 500 when invalid date is passed", function (done) {
    chai
      .request(app)
      .get("/stations/1/ridersByAge?date=2019-04-02x")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
  ...
  it("Should 500 when missing stationId", function (done) {
    chai
      .request(app)
      .get("/stations/ridersByAge?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
        expect(res.body.errors).to.eql("Invalid Number");
...
describe("Get Top 20 Recent Trips", function () {
  it("Should return JSON", function (done) {
    chai
      .request(app)
      .get("/stations/3/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res, JSON.stringify(res.body)).to.have.status(200);
  ...
  it("Should return JSON for multiple station ids", function (done) {
    chai
      .request(app)
      .get("/stations/2/3/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res, JSON.stringify(res.body)).to.have.status(200);
  ...
  it("Should return 0 items when no trips", function (done) {
    chai
      .request(app)
      .get("/stations/1/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res, JSON.stringify(res.body)).to.have.status(200);
  ...
  it("Should return only 20 items when more than 20 trips available", function (done) {
    chai
      .request(app)
      .get("/stations/2/3/211/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res, JSON.stringify(res.body)).to.have.status(200);
  ...
  it("Should 500 when invalid stationId is passed", function (done) {
    chai
      .request(app)
      .get("/stations/xxx/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
        expect(res.body.errors).to.eql("Invalid Number");
  ...
  it("Should 500 when invalid date is passed", function (done) {
    chai
      .request(app)
      .get("/stations/1/recentTrips?date=2019-04-02x")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
        expect(res.body.errors).to.eql("Invalid Date");
  ...
  it("Should 500 when missing stationId", function (done) {
    chai
      .request(app)
      .get("/stations/recentTrips?date=2019-04-02")
      .set("authorization", authToken)
      .end((err, res) => {
        expect(res).to.have.status(500);
        expect(res.body.errors).to.eql("Invalid Number");
